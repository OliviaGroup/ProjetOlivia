...
public class MainActivity extends AppCompatActivity implements ChangeProfileFragment.OnChange, ScoreFragment.OnEndOfGame {
    ...
    public void onBackToMenu() {
        GameFragment gameFragment = (GameFragment) getSupportFragmentManager().getFragments().get(2);
        if(gameFragment != null){
            gameFragment.backToMenu();
        }
    }
