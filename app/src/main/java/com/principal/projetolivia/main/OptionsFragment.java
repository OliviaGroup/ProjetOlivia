    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        changeProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentTransaction ft = getFragmentManager().beginTransaction().add(R.id.containerSubjects, new ChangeProfileFragment());
        ...
        AlertDialog myQuittingDialogBox =new AlertDialog.Builder(getContext())
                ...
                .setPositiveButton(getContext().getString(R.string.delete), new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        dialog.dismiss();
                        Intent newActivity = new Intent(getActivity().getBaseContext(), ProfileActivity.class);
                        getActivity().finish();
